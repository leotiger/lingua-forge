...
- **Every public Custom Post Type, zero configuration** — Lang column, AI metabox, FSE template routing, and link fixer apply to all CPTs automatically. WPML and Polylang translate CPTs too, but you enable each type in settings; Lingua Forge needs no setup.
