...
- [Configuration](#configuration)
  - [Language Router](#language-router-1)
  - [AI Content Tools](#ai-content-tools-1)
- [Architecture](#architecture)
  - [Constants](#constants)
  - [WordPress-core and FSE conformance](#wordpress-core-and-fse-conformance)
...
- [Language Router — detailed reference](#language-router--detailed-reference)
  ...
  - [Language Switcher (LSFLR)](#language-switcher-lsflr)
  - [FSE template localisation](#fse-template-localisation)
  - [Admin UX](#admin-ux)
  - [Overriding plugin translation strings](#overriding-plugin-translation-strings)
...
- [Known Issues and Troubleshooting](#known-issues-and-troubleshooting)
  - [AI request times out or returns a white screen on long content](#ai-request-times-out-or-returns-a-white-screen-on-long-content)
  - [AI returns an empty result or "generation failed" with no error detail](#ai-returns-an-empty-result-or-generation-failed-with-no-error-detail)
  - [Translation is cut off at the end of a long page](#translation-is-cut-off-at-the-end-of-a-long-page)
  - [Editor toolbar Quick Translate button does not appear on first load](#editor-toolbar-quick-translate-button-does-not-appear-on-first-load)
  - [Meta description generator uses old content after applying a translation](#meta-description-generator-uses-old-content-after-applying-a-translation)
  - [Footnotes are not imported between translation pages](#footnotes-are-not-imported-between-translation-pages)
  - [Language navigation shows pages from all languages (Page List block)](#language-navigation-shows-pages-from-all-languages-page-list-block)
