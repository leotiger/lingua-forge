...
function lf_update_manifest_endpoint(): WP_REST_Response {
	...
	$sha256 = 'cb9237c1bbe0bce204c7ab4d9f7bb7ace247d6a347444ea85f3a17979122b629';
	...
	$changelog =
		...
		'<ul>' .
			...
			'<li><strong>Added:</strong> &#8220;Recreate All Languages (Template Parts Only)&#8221; &#8212; a second global button for refreshing just headers/footers/etc. across every language, without also rebuilding templates, re-translating, or running the link/part-ref fixers. Same sequencing, Cancel behaviour, and failure summary as the full run. (<code>ai/assets/fse-global-actions.js</code>, <code>ai/includes/Admin/Settings/Tabs/RouterTab.php</code>)</li>' .
			'<li><strong>Added:</strong> &#8220;Recreate All Languages (Templates Only)&#8221; &#8212; a third global button, the mirror of Template Parts Only: runs Re-create all templates, Translate all, Fix all parts, and Fix all links across every language, leaving template parts untouched. (<code>ai/assets/fse-global-actions.js</code>, <code>ai/includes/Admin/Settings/Tabs/RouterTab.php</code>)</li>' .
			'<li><strong>Added:</strong> &#8220;Translate all&#8221;, &#8220;Fix all links&#8221;, and &#8220;Fix all navs&#8221; bulk buttons to the per-language Template Parts toolbar, bringing it to parity with the Templates panel (which already had these). Previously only &#8220;Re-create all&#8221; was available there. (<code>ai/assets/fse-translate.js</code>, <code>ai/assets/fse-link-fixer.js</code>, <code>ai/assets/fse-part-fixer.js</code>, <code>ai/includes/Admin/Settings/Tabs/Sections/TemplatePartsSection.php</code>)</li>' .
		'</ul>' .
